import { c as Z, f as J, g as U, u as q, a as D, b as G, d as $, t as M, _ as E, j as e, B as H, E as K, C as Q, e as X, h as Y, i as I, k as V, M as ee, l as O, D as se, m as te, N as ne, n as ie, R as ae, o as N, p as oe, q as re, r as le, S as ce } from "./index-CHYS0LqX.mjs";
...
const fe = (i) => async () => {
  ...
  () => import("./PieChartComponent-C8Sfq-ov.mjs")
), ge = () => {
  var S;
  const i = q();
  let t = D((r) => r.admin);
...
x(
  () => import("./LandingFeedPage-C9jMfrpt.mjs")
);
x(
  () => import("./AdminProfile-Ceovu0Nx.mjs")
);
x(
  () => import("./MasjidProfile-DDZf1fSd.mjs")
);
x(
  () => import("./MasjidAnnouncementPage-CIlK9d-6.mjs")
);
x(
  () => import("./MasjidEventsPage-fW14EtMO.mjs")
);
x(
  () => import("./EventProfile-Dm6MrLt6.mjs")
);
x(
  () => import("./MasjidTimings-DV8xS815.mjs")
);
x(
  () => import("./MasjidUploadTimings-DJhrP78Z.mjs")
);
const ye = () => {
